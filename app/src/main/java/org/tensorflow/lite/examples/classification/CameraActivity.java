...
import org.tensorflow.lite.examples.classification.fragments.NewMissionDialogFragment;
...
public abstract class CameraActivity extends AppCompatActivity
    implements OnImageAvailableListener,
        ...
        HomeFragment.OnFragmentInteractionListener, NewMissionDialogFragment.OnFragmentInteractionListener{
  ...
  public void onStartMission(int minutes, int mLength, int mWidth) {
    for(androidx.fragment.app.Fragment fragment : getSupportFragmentManager ().getFragments()){
      if(fragment instanceof HomeFragment){
        ((HomeFragment)fragment).onStartMission(minutes, mLength, mWidth);
        break;
      }
    }
  }
